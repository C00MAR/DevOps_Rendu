    ...
    <div className={`bg-dark-card border border-dark-border  rounded-lg p-4 transition-all duration-200 hover:border-dark-hover ${
      ...
      <div className="flex items-start gap-4 ">
        <input
          ...
          className="mt-1 h-4 w-4 text-gray-600 border-gray-300  rounded-full focus:ring-gray-500 focus:ring-2 appearance-none checked:bg-gray-600 checked:border-transparent"
          style={{
        WebkitAppearance: 'none',
        appearance: 'none',
        borderRadius: '9999px',
        border: '2px solid #d1d5db',
        backgroundColor: todo.completed ? '#4b5563' : '#fff',
